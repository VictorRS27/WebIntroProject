<template>
  <Navbar />
  <ProductPurchase
  v-for="(product, index) in productpurchase" :key="product.id" :infos="product" @emit-product="updateProduct"/>
...
export default {
  ...
  methods: {
    ...
    updateProduct(product) {
      this.productpurchase[0] = product;
      console.log("this.productpurchase = ", this.productpurchase);
    },
  },
};
</script>
