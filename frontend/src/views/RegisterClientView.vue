<template>
    ...
    <div class="container">
        <div class="box">
            ...
            <div v-show="success">
                <p>User {{ username }} was registered!</p>
...
export default {
    ...
    methods: {
        ...
        load_edit() {
            ...
            if (this.item_id !== -1) {
                axios
                .get("http://localhost:3000/users/" + this.item_id)
                .then((response) => {
                ...
                if (this.item_id == -1) {
                    ...
                    .then((adminResponse) => {
                        ...
                        .then((usersResponse) => {
                            ...
                            axios
                            .post("http://localhost:3000/users", newClient)
                            .then((response) => {
                                this.user;
                    ...
                    axios
                    .put(`http://localhost:3000/users/${this.item_id}`, newClient)
                    .then((response) => {
